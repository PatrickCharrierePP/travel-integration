...
/***/ "./apps/planpay-next-seed/src/data.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.checkoutItems = exports.checkouts = exports.userPaymentMethods = exports.userPaymentIdentityIds = exports.userMerchantRoles = exports.users = exports.merchantPaymentPlatformCurrencies = exports.merchantPaymentPlatforms = exports.merchantServiceIdentityRoles = exports.merchantServiceIdentities = exports.merchants = exports.paymentPlatforms = exports.permissions = exports.rolePermissions = exports.roles = exports.checkoutOperator = exports.addresses = exports.countries = exports.currencies = exports.australianDollars = void 0;
...
// ===== Currency =====
exports.australianDollars = {
    currencyCode: 'AUD',
    label: 'Australian dollars',
    currencySymbol: '$',
    format: 'AustralianCurrencyFormatter',
};
exports.currencies = [exports.australianDollars];
// ===== Country =====
const australia = {
    alpha3Code: 'AUS',
    alpha2Code: 'AU',
    defaultCurrencyCode: exports.australianDollars.currencyCode,
    defaultLocale: 'en-AU',
    name: 'Australia',
};
exports.countries = [australia];
// ===== Address =====
const address1 = {
    id: 'kwor6572pyco',
    line1: '11 York Street',
    line2: 'Level 7',
    city: 'Wynard',
    state: 'NSW',
    postcode: '2002',
    countryAlpha3Code: australia.alpha3Code,
};
const address2 = {
    id: 'jbqrmhaok3id',
...
exports.addresses = [address1, address2, address3, address4];
// ===== Plan permissions =====
...
const canModifyPlan = {
    ...
    subject: PLAN_SUBJECT,
    description: 'Modify a plan.',
};
// ===== Role =====
const merchantAdministrator = {
    id: '1',
    label: 'Merchant Administrator',
};
const merchantReader = {
    id: '2',
    label: 'Merchant Viewer',
};
exports.checkoutOperator = {
    id: '3',
    label: 'Checkout Operator',
};
exports.roles = [merchantAdministrator, merchantReader, exports.checkoutOperator];
// ===== RolePermission =====
const CHECKOUT_SUBJECT = 'checkout';
const canViewCheckout = {
    id: '200',
    action: Actions.read,
    subject: CHECKOUT_SUBJECT,
    description: 'View a checkout.',
};
...
const canModifyCheckout = {
    id: '202',
    action: Actions.update,
    subject: CHECKOUT_SUBJECT,
    description: 'Modify a checkout.',
};
exports.rolePermissions = [
    // "Merchant Administrator"
    { roleId: merchantAdministrator.id, permissionId: canViewPlan.id },
    { roleId: merchantAdministrator.id, permissionId: canCreatePlan.id },
    { roleId: merchantAdministrator.id, permissionId: canModifyPlan.id },
    // "Merchant Reader"
    { roleId: merchantReader.id, permissionId: canViewPlan.id },
    //  "Checkout Operator"
    { roleId: exports.checkoutOperator.id, permissionId: canCreateCheckout.id },
    { roleId: exports.checkoutOperator.id, permissionId: canViewCheckout.id },
    { roleId: exports.checkoutOperator.id, permissionId: canModifyCheckout.id },
];
// ===== Permission =====
exports.permissions = [
    canViewPlan,
...
// ===== PaymentPlatform =====
const planpayManagedStripe = {
    id: '79a26ad1085b',
    label: 'planpay managed Stripe',
    vendor: client_1.PaymentPlatform_vendor.Stripe,
    variant: client_1.PaymentPlatform_variant.Managed,
};
exports.paymentPlatforms = [planpayManagedStripe];
// ===== Merchant =====
const ovoloHotels = {
    id: '62bd1b7e5e8b',
    name: 'Ovolo Hotels',
    companyEmail: 'ovoloHotels@yopmail.com',
    phoneNumber: '+84 7979 7979',
    merchantSupportEmail: 'planpaymerchantsupport_ovoloHotels@gmail.com',
    customerSupportEmail: 'planpaycustomersupport_ovoloHotels@gmail.com',
    defaultMinimumDepositType: client_1.Merchant_minimumDepositType.Percentage,
    defaultMinimumDepositValue: 10,
    merchantPageUrl: 'https://ovolohotels.com',
    defaultPaymentDeadlineInDays: 15,
...
const enadHotels = {
    id: '62972bbf7919',
    name: 'Enad Hotels',
    companyEmail: 'enadHotels@yopmail.com',
    phoneNumber: '+6111 1111 1111',
    merchantSupportEmail: 'planpaymerchantsupport_enadHotels@gmail.com',
    customerSupportEmail: 'planpaycustomersupport_enadHotels@gmail.com',
    defaultMinimumDepositType: client_1.Merchant_minimumDepositType.Currency,
    defaultMinimumDepositValue: 200,
    merchantPageUrl: 'https://enadHotels.example.com/',
    defaultPaymentDeadlineInDays: 30,
    serviceFeePercentage: 5,
...
const noraaTravel = {
    id: '630880668a41',
    name: 'Noraa Travel',
    companyEmail: 'noraaTravel@yopmail.com',
    phoneNumber: '+6111 1111 1111',
    merchantSupportEmail: 'planpaymerchantsupport_noraaTravel@gmail.com',
    customerSupportEmail: 'planpaycustomersupport_noraaTravel@gmail.com',
    defaultMinimumDepositType: client_1.Merchant_minimumDepositType.Currency,
    defaultMinimumDepositValue: 200,
    merchantPageUrl: 'https://noraaTravel.example.com/',
    billingAddressId: address3.id,
    defaultPaymentDeadlineInDays: 30,
    serviceFeePercentage: 5,
};
const shonrateHotels = {
    id: '631adba97bf3',
    name: 'Shonrate Hotels',
    companyEmail: 'shonrateHotels@yopmail.com',
    phoneNumber: '+6111 1111 1111',
    merchantSupportEmail: 'planpaymerchantsupport_shonrateHotels@gmail.com',
    customerSupportEmail: 'planpaycustomersupport_shonrateHotels@gmail.com',
    defaultMinimumDepositType: client_1.Merchant_minimumDepositType.Currency,
    defaultMinimumDepositValue: 200,
    merchantPageUrl: 'https://shonrateHotels.example.com/',
    billingAddressId: address4.id,
    defaultPaymentDeadlineInDays: 30,
    serviceFeePercentage: 5,
};
exports.merchants = [enadHotels, noraaTravel, ovoloHotels, shonrateHotels];
// ===== MerchantServiceIdentity =====
const ovoloHotelsMerchantServiceIdentity1 = {
    id: '4c6cx80g5coy',
    merchantId: ovoloHotels.id,
    description: `${ovoloHotels.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_OVOLO_HOTELS_1 || '',
};
const ovoloHotelsMerchantServiceIdentity2 = {
    id: '41cek9j294ot',
    merchantId: ovoloHotels.id,
    description: `${ovoloHotels.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_OVOLO_HOTELS_2 || '',
};
const enadHotelsMerchantServiceIdentity1 = {
    id: 'asd12397acas',
    merchantId: enadHotels.id,
    description: `${enadHotels.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_ENAD_1 || '',
};
const enadHotelsMerchantServiceIdentity2 = {
    id: 'asdb1e0112sd',
    merchantId: enadHotels.id,
    description: `${enadHotels.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_ENAD_2 || '',
};
const noraaTravelMerchantServiceIdentity1 = {
    id: 'nsda9s821bds',
    merchantId: noraaTravel.id,
    description: `${noraaTravel.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_NORAA_1 || '',
};
const noraaTravelMerchantServiceIdentity2 = {
    id: '41ce294ot1ca',
    merchantId: noraaTravel.id,
    description: `${noraaTravel.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_NORAA_2 || '',
};
const shonrateHotelsMerchantServiceIdentity1 = {
    id: '2babbd93bb73',
    merchantId: shonrateHotels.id,
    description: `${shonrateHotels.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_SHONRATE_HOTELS_1 || '',
};
const shonrateHotelsMerchantServiceIdentity2 = {
    id: '0a0224252e37',
    merchantId: shonrateHotels.id,
    description: `${shonrateHotels.name} checkout API key`,
    secretValue: process_1.env.API_SECRET_VALUE_SHONRATE_HOTELS_2 || '',
};
exports.merchantServiceIdentities = [
    ovoloHotelsMerchantServiceIdentity1,
    ovoloHotelsMerchantServiceIdentity2,
    enadHotelsMerchantServiceIdentity1,
    enadHotelsMerchantServiceIdentity2,
    noraaTravelMerchantServiceIdentity1,
    noraaTravelMerchantServiceIdentity2,
    shonrateHotelsMerchantServiceIdentity1,
    shonrateHotelsMerchantServiceIdentity2,
];
// ===== MerchantServiceIdentityRole =====
const ovoloHotelsMerchantServiceIdentityRole1 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: ovoloHotelsMerchantServiceIdentity1.id,
};
const ovoloHotelsMerchantServiceIdentityRole2 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: ovoloHotelsMerchantServiceIdentity2.id,
};
const enadHotelsMerchantServiceIdentityRole1 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: enadHotelsMerchantServiceIdentity1.id,
};
const enadHotelsMerchantServiceIdentityRole2 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: enadHotelsMerchantServiceIdentity2.id,
};
const noraaTravelMerchantServiceIdentityRole1 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: noraaTravelMerchantServiceIdentity1.id,
};
const noraaTravelMerchantServiceIdentityRole2 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: noraaTravelMerchantServiceIdentity2.id,
};
const shonrateHotelsMerchantServiceIdentityRole1 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: shonrateHotelsMerchantServiceIdentity1.id,
};
const shonrateHotelsMerchantServiceIdentityRole2 = {
    roleId: exports.checkoutOperator.id,
    merchantServiceIdentityId: shonrateHotelsMerchantServiceIdentity2.id,
};
exports.merchantServiceIdentityRoles = [
    ovoloHotelsMerchantServiceIdentityRole1,
    ovoloHotelsMerchantServiceIdentityRole2,
    enadHotelsMerchantServiceIdentityRole1,
    enadHotelsMerchantServiceIdentityRole2,
    noraaTravelMerchantServiceIdentityRole1,
    noraaTravelMerchantServiceIdentityRole2,
    shonrateHotelsMerchantServiceIdentityRole1,
    shonrateHotelsMerchantServiceIdentityRole2,
];
// ===== MerchantPaymentPlatform =====
const shonrateHotelsPaymentPlatform = {
    id: '3fb79abda136',
    merchantId: shonrateHotels.id,
    default: true,
    paymentPlatformId: planpayManagedStripe.id,
};
const noraaTravelPaymentPlatform = {
    id: '0lbl2abda742',
    merchantId: noraaTravel.id,
    default: true,
    paymentPlatformId: planpayManagedStripe.id,
};
exports.merchantPaymentPlatforms = [
    shonrateHotelsPaymentPlatform,
    noraaTravelPaymentPlatform,
];
// ===== MerchantPaymentPlatformCurrency =====
const noraaTravelPaymentPlatformAUD = {
    id: 'xcz123m09kp2',
    merchantPaymentPlatformId: noraaTravelPaymentPlatform.id,
    currencyCode: exports.australianDollars.currencyCode,
    default: true,
    fixedTransactionFeeAmount: 0.1,
    fixedTransactionFeePercentage: 1,
    transactionFeeCurrencyCode: exports.australianDollars.currencyCode,
    scope: client_1.MerchantPaymentPlatformCurrency_scope.Domestic,
};
const shonrateHotelsPaymentPlatformAUD = {
    id: 'm09kp2xcz123',
    merchantPaymentPlatformId: shonrateHotelsPaymentPlatform.id,
    currencyCode: exports.australianDollars.currencyCode,
    default: true,
    fixedTransactionFeeAmount: 0.1,
    fixedTransactionFeePercentage: 1,
...
exports.merchantPaymentPlatformCurrencies = [
    noraaTravelPaymentPlatformAUD,
    shonrateHotelsPaymentPlatformAUD,
];
// ===== User =====
const alice = {
    id: 'b64e71ac1c68',
    emailAddress: 'alice@planpay.com.au',
    status: client_1.User_status.Active,
    firstName: 'Alice',
    lastName: 'Anderson',
    phoneNumber: '+6111 1111 1111',
    password: process_1.env.USER_PASSWORD_ALICE || '',
};
const bob = {
    id: 'd0ee0aea1c68',
    emailAddress: 'bob@planpay.com.au',
    status: client_1.User_status.Active,
    firstName: 'Bob',
    lastName: 'Baker',
    phoneNumber: '+6111 1111 1111',
    password: process_1.env.USER_PASSWORD_BOB || '',
};
const carmen = {
    id: '0e59f7041c69',
    emailAddress: 'carmen.sandiego@planpay.com.au',
    status: client_1.User_status.Blocked,
    firstName: 'Carmen',
    lastName: 'Sandiego',
    phoneNumber: '+6111 1111 1111',
    password: process_1.env.USER_PASSWORD_CARMEN || '',
};
exports.users = [carmen, alice, bob];
// ===== UserMerchantRoles =====
exports.userMerchantRoles = [
    {
        userId: carmen.id,
        merchantId: noraaTravel.id,
        roleId: merchantAdministrator.id,
    },
    {
        userId: alice.id,
        merchantId: enadHotels.id,
...
// ===== UserPaymentIdentity =====
const alicePaymentIdentity = {
    id: '79a26ad1085c',
    userId: alice.id,
    externalCustomerId: 'DUMMY_PAYMENT_PLATFORM_ID',
    merchantPaymentPlatformId: noraaTravelPaymentPlatform.id,
};
exports.userPaymentIdentityIds = [alicePaymentIdentity];
// ===== UserPaymentMethod =====
const alicePaymentMethodVisa = {
    id: 'd1083c79a26a',
    userPaymentIdentityId: alicePaymentIdentity.id,
    cardBrand: 'visa',
    expMonth: 6,
    expYear: 2026,
    last4Digits: '2344',
    funding: client_1.Card_type.Credit,
    token: 'DUMMY_PAYMENT_PLATFORM_TOKEN',
    description: 'DUMMY_DESCRIPTION',
};
exports.userPaymentMethods = [alicePaymentMethodVisa];
// ===== Checkout =====
const checkout1 = {
    id: 'n1083c79a35b',
    merchantId: noraaTravel.id,
    merchantOrderId: 'n1068m79a42g',
    currencyCode: 'AUD',
    checkoutExpiry: (0, date_fns_1.add)(new Date(Date.now()), { months: 6 }),
    redirectURL: noraaTravel.merchantPageUrl,
};
exports.checkouts = [checkout1];
// ===== CheckoutItem =====
const checkoutItem1 = {
    id: 'asdbo13he10s',
    sku: 'asd',
    merchantProductURL: noraaTravel.merchantPageUrl,
    quantity: 1,
    description: 'item 1',
    costPerItem: 5000,
    minimumDepositPerItemValue: noraaTravel.defaultMinimumDepositValue,
    minimumDepositPerItemType: noraaTravel.defaultMinimumDepositType,
    depositRefundable: true,
    redemptionDate: (0, date_fns_1.add)(new Date(Date.now()), { years: 1 }),
    checkoutId: checkout1.id,
};
exports.checkoutItems = [checkoutItem1];
...
/***/ "./packages/planpay-next-lib/src/checkout/calculation.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.calculateInstallments = exports.calculateInstallmentAmount = exports.calculateInstallmentCount = exports.CalculatePlanOutput = exports.CalculatePlanParams = exports.InstallmentRequestSchema = exports.Cadence = exports.DepositRequestSchema = exports.Plan_cadenceOnDayOfWeek = exports.Plan_installmentFrequency = void 0;
const client_1 = __webpack_require__("@prisma/client");
var client_2 = __webpack_require__("@prisma/client");
Object.defineProperty(exports, "Plan_installmentFrequency", ({ enumerable: true, get: function () { return client_2.Plan_installmentFrequency; } }));
Object.defineProperty(exports, "Plan_cadenceOnDayOfWeek", ({ enumerable: true, get: function () { return client_2.Plan_cadenceOnDayOfWeek; } }));
...
const isValidIANA = (timeZone) => {
    try {
        return new Intl.DateTimeFormat(undefined, { timeZone }) !== null;
    }
    catch (_a) {
        return false;
    }
...
exports.DepositRequestSchema = zod_1.z
    ...
    .optional();
exports.Cadence = zod_1.z.object({
    frequency: zod_1.z.nativeEnum(client_1.Plan_installmentFrequency),
    on: zod_1.z.object({
        dayOfWeek: zod_1.z.nativeEnum(client_1.Plan_cadenceOnDayOfWeek).optional(),
        dayOfMonth: zod_1.z.number().optional(),
    }),
});
exports.InstallmentRequestSchema = zod_1.z
    .object({
    cadence: exports.Cadence,
})
    .optional();
exports.CalculatePlanParams = zod_1.z.object({
    ...
    deposit: zod_1.z
        ...
        .optional(),
    installments: exports.InstallmentRequestSchema.optional(),
    timeZone: zod_1.z.string().refine((e) => isValidIANA(e), {
        message: 'Not a valid IANA timezone.',
    }),
});
exports.CalculatePlanOutput = zod_1.z.object({
    type: zod_1.z.enum(['plan']),
...
const calculateInstallmentCount = ({ installmentFrequency, cadenceDay, startDate, endDate, }) => {
    var _a, _b;
    const cadenceDays = Object.keys(client_1.Plan_cadenceOnDayOfWeek);
    if ((installmentFrequency === client_1.Plan_installmentFrequency.Weekly &&
        !cadenceDays.includes((_a = cadenceDay === null || cadenceDay === void 0 ? void 0 : cadenceDay.toString()) !== null && _a !== void 0 ? _a : '')) ||
        (installmentFrequency === client_1.Plan_installmentFrequency.Fortnightly &&
            !cadenceDays.includes((_b = cadenceDay === null || cadenceDay === void 0 ? void 0 : cadenceDay.toString()) !== null && _b !== void 0 ? _b : '')))
        throw new Error('cadenceDay must be a value of Plan_cadenceOnDayOfWeek enum.');
    if (installmentFrequency === client_1.Plan_installmentFrequency.Monthly &&
        typeof cadenceDay !== 'number')
        throw new Error('cadenceDay must be a value number value ranging between 1-31.');
    if (installmentFrequency === client_1.Plan_installmentFrequency.Weekly) {
        let nextStartDate = startDate;
        if (cadenceDay) {
            nextStartDate = (0, date_fns_1.nextDay)(startDate, (cadenceDays.indexOf(cadenceDay) + 1));
            nextStartDate =
                (0, date_fns_1.differenceInDays)(startDate, nextStartDate) > 6
                    ? nextStartDate
                    : (0, date_fns_1.nextDay)((0, date_fns_1.add)(startDate, { weeks: 1 }), (cadenceDays.indexOf(cadenceDay) +
                        1));
        }
        return (0, date_fns_1.differenceInWeeks)(endDate, nextStartDate) + 1;
    }
    else if (installmentFrequency === client_1.Plan_installmentFrequency.Fortnightly) {
        let nextStartDate = startDate;
        if (cadenceDay) {
            nextStartDate = (0, date_fns_1.nextDay)((0, date_fns_1.add)(startDate, { weeks: 1 }), (cadenceDays.indexOf(cadenceDay) + 1));
            nextStartDate =
                (0, date_fns_1.differenceInDays)(startDate, nextStartDate) > 13
                    ? nextStartDate
                    : (0, date_fns_1.nextDay)((0, date_fns_1.add)(startDate, { weeks: 2 }), (cadenceDays.indexOf(cadenceDay) +
                        1));
        }
        return Math.floor((0, date_fns_1.differenceInWeeks)(endDate, nextStartDate) / 2) + 1;
    }
    else if (installmentFrequency === client_1.Plan_installmentFrequency.Monthly) {
        const cadence = cadenceDay > (0, date_fns_1.getDaysInMonth)(startDate)
            ? (0, date_fns_1.getDaysInMonth)(startDate)
            : cadenceDay;
        const nextStartDate = startDate.getDay() > (cadence !== null && cadence !== void 0 ? cadence : 32) ||
            (0, date_fns_1.differenceInDays)((0, date_fns_1.set)(startDate, { date: cadence }), startDate) < 16
            ? (0, date_fns_1.add)((0, date_fns_1.set)(startDate, { date: cadence }), { months: 1 })
            : (0, date_fns_1.set)(startDate, { date: cadence });
        return (0, date_fns_1.differenceInMonths)((0, date_fns_1.add)(endDate, { days: 1 }), // HOTFIX, IDEAS?
        nextStartDate);
    }
    else
        throw new Error('Unhandled plan installmentFrequency.');
};
exports.calculateInstallmentCount = calculateInstallmentCount;
const calculateInstallmentAmount = ({ totalCost, installmentCount, deposit = 0, }) => {
    const decTotalCost = new runtime_1.Decimal(totalCost).sub(deposit).times(100);
    const decInstallmentRemainder = decTotalCost.modulo(installmentCount);
    const decInstallmentAmount = decTotalCost
        .sub(decInstallmentRemainder)
        .dividedBy(installmentCount);
    return {
        installmentRounded: decInstallmentAmount.dividedBy(100).toNumber(),
        installmentRemainder: decInstallmentRemainder.dividedBy(100).toNumber(),
    };
};
exports.calculateInstallmentAmount = calculateInstallmentAmount;
const calculateInstallments = ({ installmentFrequency, cadenceDay, startDate, endDate, totalCost, deposit, timeZone, }) => {
    var _a;
    const localStartDate = (0, date_fns_tz_1.toDate)(startDate, { timeZone });
    const localEndDate = (0, date_fns_tz_1.toDate)(endDate, { timeZone });
    const installmentCount = (0, exports.calculateInstallmentCount)({
        installmentFrequency: installmentFrequency !== null && installmentFrequency !== void 0 ? installmentFrequency : 'Weekly',
        cadenceDay: cadenceDay !== null && cadenceDay !== void 0 ? cadenceDay : client_1.Plan_cadenceOnDayOfWeek.Monday,
        startDate: localStartDate,
        endDate: localEndDate,
    });
    const { installmentRounded, installmentRemainder } = (0, exports.calculateInstallmentAmount)({
        totalCost,
        installmentCount,
        deposit,
    });
    return {
        ...
        installments: {
            amount: installmentRounded,
            remainder: installmentRemainder,
            count: installmentCount,
            cadence: {
                frequency: (_a = installmentFrequency) !== null && _a !== void 0 ? _a : 'Weekly',
                on: {
                    dayOfWeek: installmentFrequency === client_1.Plan_installmentFrequency.Weekly ||
                        installmentFrequency === client_1.Plan_installmentFrequency.Fortnightly
                        ? cadenceDay
                        : undefined,
                    dayOfMonth: installmentFrequency === client_1.Plan_installmentFrequency.Monthly
                        ? cadenceDay
                        : undefined,
                },
            },
...
function getTotalCost(items) {
    return items.reduce((aggr, item) => aggr + item.costPerItem.times(item.quantity).toNumber(), 0);
}
...
function getCompletionDate(items) {
    return (0, date_fns_1.min)(items.map((v) => (0, date_fns_1.sub)(v.redemptionDate, { days: v.paymentDeadline })));
}
...
const calculation_1 = __webpack_require__("./packages/planpay-next-lib/src/checkout/calculation.ts");
...
let CheckoutService = class CheckoutService {
    ...
    calculatePlan(params) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const totalCost = (0, checkout_1.getTotalCost)(checkout.items);
            const installments = (0, calculation_1.calculateInstallments)({
                installmentFrequency: (_b = (_a = params.installments) === null || _a === void 0 ? void 0 : _a.cadence.frequency) !== null && _b !== void 0 ? _b : client_1.Plan_installmentFrequency.Weekly,
                cadenceDay: ((_c = params.installments) === null || _c === void 0 ? void 0 : _c.cadence.frequency) ==
                    client_1.Plan_installmentFrequency.Monthly
                    ? (_e = (_d = params.installments) === null || _d === void 0 ? void 0 : _d.cadence.on.dayOfMonth) !== null && _e !== void 0 ? _e : 1
                    : (_g = (_f = params.installments) === null || _f === void 0 ? void 0 : _f.cadence.on.dayOfWeek) !== null && _g !== void 0 ? _g : client_1.Plan_cadenceOnDayOfWeek.Monday,
                startDate: new Date(Date.now()),
                endDate: (0, checkout_1.getCompletionDate)(checkout.items.map(({ redemptionDate, paymentDeadline }) => ({
                    redemptionDate,
                    paymentDeadline: paymentDeadline !== null && paymentDeadline !== void 0 ? paymentDeadline : 0,
                }))),
                deposit: (_j = (_h = params.deposit) === null || _h === void 0 ? void 0 : _h.amount) !== null && _j !== void 0 ? _j : 0,
                totalCost,
                timeZone: params.timeZone,
            });
            yield this.prisma.checkout.update({
                where: {
                    id: params.checkoutId,
                },
                data: {
            ...
            const output = Object.assign(Object.assign({ type: 'plan' }, installments), { currencyCode: checkout.currencyCode, redirectURL: checkout.redirectURL, totalCost });
            return output;
        });
    }
};
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./packages/planpay-next-lib/src/checkout/calculation.ts"), exports);
tslib_1.__exportStar(__webpack_require__("./packages/planpay-next-lib/src/checkout/checkoutService.ts"), exports);


/***/ }),

/***/ "./packages/planpay-next-lib/src/generated/schemas/enums/Plan_cadenceOnDayOfWeek.schema.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Plan_cadenceOnDayOfWeekSchema = void 0;
const zod_1 = __webpack_require__("zod");
exports.Plan_cadenceOnDayOfWeekSchema = zod_1.z.enum([
    'Monday',
    'Tuesday',
    'Wednesday',
    'Thursday',
...
/***/ "./packages/planpay-next-lib/src/generated/schemas/enums/Plan_installmentFrequency.schema.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Plan_installmentFrequencySchema = void 0;
const zod_1 = __webpack_require__("zod");
exports.Plan_installmentFrequencySchema = zod_1.z.enum([
    'Weekly',
    'Fortnightly',
    'Monthly',
]);
...
/***/ "./packages/planpay-next-lib/src/generated/schemas/enums/Plan_status.schema.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Plan_statusSchema = void 0;
const zod_1 = __webpack_require__("zod");
exports.Plan_statusSchema = zod_1.z.enum([
    'OnSchedule',
    'Late',
    'Completed',
    'Cancelled',
...
tslib_1.__exportStar(__webpack_require__("./packages/planpay-next-lib/src/utils/index.ts"), exports);
...
var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.StripePlatform = exports.SaveStripePaymentMethodParam = exports.MakePaymentParams = exports.UserPaymentIdentityParam = exports.SetupPaymentIdentityParams = void 0;
const tslib_1 = __webpack_require__("tslib");
const client_1 = __webpack_require__("@prisma/client");
const server_1 = __webpack_require__("@trpc/server");
...
exports.UserPaymentIdentityParam = zod_1.z.object({
...
exports.MakePaymentParams = zod_1.z.object({
    ...
    // installmentFrequency: Plan_installmentFrequencySchema,
    // cadenceOnDayOfMonth: z.number().optional(),
    // cadenceOnDayOfWeek: Plan_cadenceOnDayOfWeekSchema.optional(),
    checkoutId: zod_1.z.string(),
});
exports.SaveStripePaymentMethodParam = zod_1.z.object({
    userPaymentIdentityId: zod_1.z.string(),
    stripePaymentMethodId: zod_1.z.string(),
});
let StripePlatform = class StripePlatform {
    ...
    saveStripePaymentMethod({ userPaymentIdentityId, stripePaymentMethodId, }) {
        var _a, _b, _c, _d, _e;
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const userPaymentIdentity = yield this.getUserPaymentIdentity({
                userPaymentIdentityId,
            ...
            const paymentMethod = yield this.stripe.paymentMethods.retrieve(stripePaymentMethodId);
            if (!paymentMethod) {
                throw new server_1.TRPCError({
                    code: 'NOT_FOUND',
                    message: 'Cannot identify stripe payment method',
                });
            }
            yield this.prisma.userPaymentMethod.create({
                data: {
                    ...
                    last4Digits: (_a = paymentMethod.card) === null || _a === void 0 ? void 0 : _a.last4,
                    expMonth: (_b = paymentMethod.card) === null || _b === void 0 ? void 0 : _b.exp_month,
                    expYear: (_c = paymentMethod.card) === null || _c === void 0 ? void 0 : _c.exp_year,
                    cardBrand: (_d = paymentMethod.card) === null || _d === void 0 ? void 0 : _d.brand,
                    funding: ((_e = paymentMethod.card) === null || _e === void 0 ? void 0 : _e.funding) === 'credit'
...
var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PaymentService = exports.GetPaymentMethodParams = exports.SavePaymentMethodParams = exports.SetUpPaymentBackEndParams = void 0;
const tslib_1 = __webpack_require__("tslib");
const client_1 = __webpack_require__("@prisma/client");
// import { TRPCError } from '@trpc/server';
const tsyringe_1 = __webpack_require__("tsyringe");
const zod_1 = __webpack_require__("zod");
// import { payment } from '../trpc/routers';
...
exports.SavePaymentMethodParams = zod_1.z.object({
    userPaymentIdentityId: zod_1.z.string(),
    paymentMethodToken: zod_1.z.string(),
    paymentPlatformVendor: zod_1.z.enum([
        'Stripe',
        'Adyen',
        'BrainTree',
...
exports.GetPaymentMethodParams = zod_1.z.object({
...
let PaymentService = class PaymentService {
    ...
    savePaymentMethod({ userPaymentIdentityId, paymentPlatformVendor, paymentMethodToken, }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (paymentPlatformVendor == client_1.PaymentPlatform_vendor.Stripe) {
                const stripePaymentMethodId = paymentMethodToken;
                this.stripePlatform.saveStripePaymentMethod({
                    userPaymentIdentityId,
    ...
    getPaymentMethod({ paymentMethodId }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return yield this.prisma.userPaymentMethod.findUnique({
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.PlanService = exports.CreatePlanParams = exports.GetPlansParams = exports.GetPlanParams = void 0;
const tslib_1 = __webpack_require__("tslib");
const client_1 = __webpack_require__("@prisma/client");
const server_1 = __webpack_require__("@trpc/server");
const tsyringe_1 = __webpack_require__("tsyringe");
const zod_1 = __webpack_require__("zod");
const auth_1 = __webpack_require__("./packages/planpay-next-lib/src/auth/index.ts");
const Plan_cadenceOnDayOfWeek_schema_1 = __webpack_require__("./packages/planpay-next-lib/src/generated/schemas/enums/Plan_cadenceOnDayOfWeek.schema.ts");
const Plan_installmentFrequency_schema_1 = __webpack_require__("./packages/planpay-next-lib/src/generated/schemas/enums/Plan_installmentFrequency.schema.ts");
const Plan_status_schema_1 = __webpack_require__("./packages/planpay-next-lib/src/generated/schemas/enums/Plan_status.schema.ts");
const nanoid_1 = __webpack_require__("./packages/planpay-next-lib/src/utils/nanoid.ts");
...
exports.CreatePlanParams = zod_1.z.object({
    merchantId: zod_1.z.string().length(12),
    userId: zod_1.z.string().length(12),
    currencyCode: zod_1.z.string().length(3),
    status: Plan_status_schema_1.Plan_statusSchema,
    firstPaymentAmount: zod_1.z.number(),
    userPaymentMethodId: zod_1.z.string().length(12),
    installmentFrequency: Plan_installmentFrequency_schema_1.Plan_installmentFrequencySchema,
    cadenceOnDayOfMonth: zod_1.z.number().optional(),
    cadenceOnDayOfWeek: Plan_cadenceOnDayOfWeek_schema_1.Plan_cadenceOnDayOfWeekSchema.optional(),
    timeZone: zod_1.z.string(),
    serviceFeePercentage: zod_1.z.number(),
});
let PlanService = class PlanService {
    ...
    createPlan({ merchantId, userId, currencyCode, status, firstPaymentAmount, userPaymentMethodId, installmentFrequency, cadenceOnDayOfMonth, cadenceOnDayOfWeek, timeZone, serviceFeePercentage, }) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const plan = yield this.prisma.plan.create({
                data: {
                    id: (0, nanoid_1.generateId)(),
                    merchantId,
                    userId,
            ...
            yield this.prisma.event.create({
                data: {
                    type: client_1.Event_type.PlanCreated,
                    payload: { amount: firstPaymentAmount },
                    planId: plan.id,
                },
            });
            return plan.id;
...
exports.checkout = trpc_1.t.router({
    ...
    calculatePlan: logging_1.loggedProcedure
        .meta({
        openapi: {
            method: 'POST',
            path: '/v2/checkout/{checkoutId}/to-plan/calculate',
            tags: ['checkout'],
        },
    })
        .input(calculation_1.CalculatePlanParams)
        .output(calculation_1.CalculatePlanOutput)
        .query(({ input }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const checkoutService = dependencyInjection_1.container.resolve(checkoutService_1.CheckoutService);
        return checkoutService.calculatePlan(input);
    })),
    finalisePayment: logging_1.loggedProcedure
        .input(plan_1.CreatePlanParams)
        .mutation(({ input }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const planService = dependencyInjection_1.container.resolve(plan_1.PlanService);
        return planService.createPlan(input);
    })),
});
...
//import { MakePaymentParams } from '../../payment/paymentPlatforms/stripePlatform';
const dependencyInjection_1 = __webpack_require__("./packages/planpay-next-lib/src/utils/dependencyInjection.ts");
const trpc_1 = __webpack_require__("./packages/planpay-next-lib/src/trpc/trpc.ts");
exports.payment = trpc_1.t.router({
    ...
    getPaymentMethod: logging_1.loggedProcedure
        .input(payment_1.GetPaymentMethodParams)
        .query(({ ctx, input }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const { authn } = ctx;
        if (!authn) {
            throw new server_1.TRPCError({ code: 'UNAUTHORIZED' });
        ...
        const paymentService = dependencyInjection_1.container.resolve(payment_1.PaymentService);
        return paymentService.getPaymentMethod(input);
    })),
    savePaymentMethod: logging_1.loggedProcedure
        .input(payment_1.SavePaymentMethodParams)
        .mutation(({ ctx, input }) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        const { authn } = ctx;
        if (!authn) {
            throw new server_1.TRPCError({ code: 'UNAUTHORIZED' });
        ...
        const paymentService = dependencyInjection_1.container.resolve(payment_1.PaymentService);
        return paymentService.savePaymentMethod(input);
    })),
    // finalisePayment: loggedProcedure
    //   .input(MakePaymentParams)
    ...
    //     return paymentService.finalisePayment(input);
    //   }),
});
...
/***/ "./packages/planpay-next-lib/src/utils/index.ts":
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {


Object.defineProperty(exports, "__esModule", ({ value: true }));
const tslib_1 = __webpack_require__("tslib");
tslib_1.__exportStar(__webpack_require__("./packages/planpay-next-lib/src/utils/nanoid.ts"), exports);
...
const data_1 = __webpack_require__("./apps/planpay-next-seed/src/data.ts");
...
function main() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(data_1.currencies.map((currencyProps) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const currency = yield prisma.currency.upsert({
                where: { currencyCode: currencyProps.currencyCode },
                update: currencyProps,
                create: currencyProps,
            });
            console.log({ currency });
        })));
        console.log('=====> COUNTRY <=====');
        yield Promise.all(data_1.countries.map((countryProps) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const country = yield prisma.country.upsert({
                where: { alpha3Code: countryProps.alpha3Code },
                update: countryProps,
                create: countryProps,
            });
            console.log({ country });
        ...
        console.log('=====> ADDRESS <=====');
        yield Promise.all(data_1.addresses.map((addressProps) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const address = {
                id: addressProps.id,
                line1: addressProps.line1,
                line2: addressProps.line2 || '',
                city: addressProps.city,
                state: addressProps.state,
                postcode: addressProps.postcode,
                countryAlpha3Code: addressProps.countryAlpha3Code,
            };
            const addressRecord = yield prisma.address.upsert({
                where: { id: address.id },
                update: address,
                create: address,
            });
        ...
        yield Promise.all(data_1.permissions.map(({ id, action, subject, description }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const permission = yield prisma.permission.upsert({
                where: { id },
                update: { action, subject, description },
                create: { id, action, subject, description },
            });
            console.log({ permission });
        })));
        console.log('=====> ROLE <=====');
        yield Promise.all(data_1.roles.map(({ id, label }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        yield Promise.all(data_1.rolePermissions.map(({ roleId, permissionId }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const rolePermission = yield prisma.rolePermission.upsert({
        ...
        yield Promise.all(data_1.merchants.map((_a) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            var { billingAddressId, id } = _a, merchantProps = tslib_1.__rest(_a, ["billingAddressId", "id"]);
            const merchantResult = yield prisma.merchant.upsert({
                where: { id },
                update: merchantProps,
                create: Object.assign({ id,
                    billingAddressId }, merchantProps),
            });
            console.log({ merchantResult });
        })));
        console.log('=====> USER <=====');
        yield Promise.all(data_1.users.map((_b) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            var { id, password } = _b, userProps = tslib_1.__rest(_b, ["id", "password"]);
            const passwordHash = yield (0, planpay_next_lib_1.createHash)(password);
            const user = Object.assign(Object.assign({}, userProps), { id, passwordHash });
            const userRecord = yield prisma.user.upsert({
                where: { id },
                update: user,
                create: user,
            });
        ...
        console.log('=====> USERMERCHANTROLE <=====');
        yield Promise.all(data_1.userMerchantRoles.map(({ userId, roleId, merchantId }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const userMerchantRoleResult = yield prisma.userMerchantRole.upsert({
                where: {
                    userId_merchantId_roleId: {
                        userId,
                        roleId,
                        merchantId,
                    },
            ...
            console.log({ userMerchantRole: userMerchantRoleResult });
        })));
        console.log('=====> MERCHANTSERVICEIDENTITY =====');
        yield Promise.all(data_1.merchantServiceIdentities.map(({ id, merchantId, description, secretValue }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const secretHash = yield (0, planpay_next_lib_1.createHash)(secretValue);
            const targetState = {
                id,
                secretHash,
                merchantId,
            ...
            const merchantServiceIdentityRecord = yield prisma.merchantServiceIdentity.upsert({
                where: { id },
                update: targetState,
                create: targetState,
            });
            console.log({
                merchantServiceIdentityRecord,
            });
        })));
        console.log('=====> MERCHANTSERVICEIDENTITYROLE =====');
        yield Promise.all(data_1.merchantServiceIdentityRoles.map(({ merchantServiceIdentityId, roleId }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const merchantServiceIdentityRoleRecord = yield prisma.merchantServiceIdentityRole.upsert({
                where: {
                    merchantServiceIdentityId_roleId: {
                        merchantServiceIdentityId,
                        roleId,
                    },
                },
                update: {},
            ...
            console.log(merchantServiceIdentityRoleRecord);
        })));
        console.log('=====> PAYMENTPLATFORM  =====');
        const paymentPlatformRecords = yield Promise.all(data_1.paymentPlatforms.map((paymentPlatform) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const paymentPlatformRecord = yield prisma.paymentPlatform.upsert({
                where: { id: paymentPlatform.id },
                update: Object.assign({}, paymentPlatform),
                create: paymentPlatform,
            });
            console.log({ paymentPlatform: paymentPlatformRecord });
            return paymentPlatformRecord;
        })));
        const managedStripeRecord = paymentPlatformRecords.find(({ vendor, variant }) => vendor == client_1.PaymentPlatform_vendor.Stripe ||
            variant == client_1.PaymentPlatform_variant.Managed);
        if (!managedStripeRecord) {
            throw new RangeError('Unable to reference (default) Stripe managed payment method!');
        }
        console.log('=====> MERCHANTPAYMENTPLATFORM  =====');
        yield Promise.all(data_1.merchantPaymentPlatforms.map((props) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const key = {
                merchantId: props.merchantId,
                paymentPlatformId: props.paymentPlatformId,
            };
            const targetState = Object.assign(Object.assign({}, key), { default: props.default, id: props.id });
            const merchantPaymentPlatformRecords = yield prisma.merchantPaymentPlatform.upsert({
                where: {
                    merchantId_paymentPlatformId: key,
                },
                update: Object.assign({}, targetState),
                create: targetState,
            });
            console.log({ merchantPaymentPlatformRecords });
        })));
        console.log('=====> MERCHANTPAYMENTPLATFORMCURRENCY  =====');
        yield Promise.all(data_1.merchantPaymentPlatformCurrencies.map((props) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const currencyKey = {
                merchantPaymentPlatformId: props.merchantPaymentPlatformId,
                currencyCode: props.currencyCode,
                scope: props.scope,
            };
            // TODO - AJN - 20221031 - we should add non-zero transaction fees.
            const currencyTargetState = Object.assign(Object.assign({}, currencyKey), { id: props.id, transactionFeeCurrencyCode: props.transactionFeeCurrencyCode, default: props.default, fixedTransactionFeeAmount: props.fixedTransactionFeeAmount, fixedTransactionFeePercentage: props.fixedTransactionFeePercentage });
            const merchantPaymentPlatformCurrencyRecord = yield prisma.merchantPaymentPlatformCurrency.upsert({
                where: { merchantPaymentPlatformId_currencyCode_scope: currencyKey },
                update: Object.assign({}, currencyTargetState),
                create: currencyTargetState,
            });
            const merchantPaymentPlatformCurrencyRecords = {
                merchantPaymentPlatformCurrency: merchantPaymentPlatformCurrencyRecord,
            };
            console.log({
                merchantPaymentPlatformCurrencyRecords,
            });
        })));
        console.log('=====> USERPAYMENTIDENTITY  =====');
        yield Promise.all(data_1.userPaymentIdentityIds.map(({ id, userId, externalCustomerId, merchantPaymentPlatformId }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const targetState = {
                id,
                userId,
                externalCustomerId,
            ...
            const userPaymentIdentityRecord = yield prisma.userPaymentIdentity.upsert({
                where: { id },
                update: targetState,
                create: targetState,
            });
            console.log({ userPaymentIdentityRecord });
        })));
        console.log('=====> USERPAYMENTMETHOD  =====');
        yield Promise.all(data_1.userPaymentMethods.map(({ id, userPaymentIdentityId, cardBrand, expMonth, expYear, last4Digits, funding, token, description, }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const targetState = {
                id,
                userPaymentIdentityId,
                default: true,
            ...
            const userPaymentMethodRecords = yield prisma.userPaymentMethod.upsert({
                where: { id },
                update: targetState,
                create: targetState,
            });
            console.log({ userPaymentMethodRecords });
        })));
        console.log('=====> CHECKOUT  =====');
        yield Promise.all(data_1.checkouts.map(({ id, merchantId, merchantOrderId, currencyCode, checkoutExpiry, redirectURL, }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const targetState = {
                id,
                merchantId,
                merchantOrderId,
            ...
            const checkoutRecords = yield prisma.checkout.upsert({
                where: { id },
                update: targetState,
                create: targetState,
            });
        ...
        yield Promise.all(data_1.checkoutItems.map((checkout) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const checkoutItemRecords = yield prisma.checkoutItem.upsert({
                where: { id: checkout.checkoutId },
                update: checkout,
                create: checkout,
            });
            console.log({ checkoutItemRecords });
        })));
        // (/) upsert a PaymentPlaform for the PlanPay managed Stripe
        // (/) upsert the MerchantPaymentPlaform for the PlanPay managed Stripe for all of
        //     the existing merchants
        // (x) look into upserting the encrypted Stripe settings into the database
        //     - we may want to defer this
        console.log('###############################################');
        console.log('### COMPLETE: Seeding auth-service database ###');
        console.log('###############################################');
    });
}
main()
    ...
    .catch((e) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
    console.error(e);
    yield prisma.$disconnect();
    process.exit(1);
}));
